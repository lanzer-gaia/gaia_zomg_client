package com.gaiaonline.battle.ui
{
	...
	public class UiInventory extends MovieClip
	{
		...
		private var _tabIndices:Object = new Object();
		...
		private function initTabs():void{
			...
			//this.tabManager.addTabs(this.tabBtns.btnFoundRings, this.FoundRingsContainer);			
		}
		...
		public function set activeTab(tabName:String):void {
			...
			switch(tabName){
				case TAB_RECIPES:
					this.uiRecipes.updateRecipeList(); // do this every time or rely on refresh button?
