package com.gaiaonline.battle.ui
{
	...
	[Event(name=UiMapDisplay.FRIEND_MARKER_CLICK, type="flash.events.Event")]
	public class UiMiniMap extends MovieClip
	{
		...
		public var globalYScale:Number = 2.50;
		...
		private function resize():void{
			...
			const tmpHeight:Number = this._height - this.mcHeader.height;
