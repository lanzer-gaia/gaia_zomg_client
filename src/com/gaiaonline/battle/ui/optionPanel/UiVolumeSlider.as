package com.gaiaonline.battle.ui.optionPanel
{
	...
	public class UiVolumeSlider extends MovieClip
	{
		...
		public function setVolume(volumeLevel:Number):void  // [kja] called weakly typed from UiManager
		{
		...
		static private const FUDGE:int = 10;
		private function measureVolume():void
		{
			const newVolume:Number = Math.floor((this.sliderBtn.x-this.dragLine.x-FUDGE)/this.procStep);
