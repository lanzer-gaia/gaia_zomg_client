package com.gaiaonline.battle.ui.uiactionbar
{
	...
	public class UiItemBarRotator extends MovieClipProxy
	{
		...
		public function UiItemBarRotator(uiFramework:IUIFramework, mcItemBarRotator:UiItemBarRotatorFl):void {
		...
		private function rotate():void {
			...
			for (var i:int = 0; i<this._bars.length; i++){
				var bar:UiItemBar = this._bars[i];
				bar.mc.y = y - (i * 32)
			}
			...
			if (this.contains(this.bg1)) {
				...
				if (this.contains(this._bars[1].mc)) {
