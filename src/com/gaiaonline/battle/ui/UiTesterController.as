package com.gaiaonline.battle.ui
{
	...
	public class UiTesterController implements IUiChooserEventHandler
	{
		...
		[
			{newUi: NEW_MAP, oldUi: "", showOld:true, showNew:false},
			{newUi: NEW_TASK, oldUi: "", showOld:true, showNew:false},
			{newUi: NEW_RECREWT, oldUi: OLD_RECREWT, showOld:true, showNew:false},
		];
		...
		public function onItemChecked(itemInfo:Object):void {
			...
			GlobalEvent.eventDispatcher.dispatchEvent(new GlobalEvent(GlobalEvent.WIDGET_SHOW, {widgetName:name, widgetShow:show, widgetEnable:true}));			
		}		
	}
}