package com.gaiaonline.battle.moduleManagers
{
	...
	final public class CrewListModuleManager implements IModuleManager, IAsyncCreationHandler
	{
		...
		private function onTeamUpdated(e:GlobalEvent):void {
			...
			if (ActorManager.getInstance().myActor.teamList.length >= 1){
				for (var i:int = 0; i < ActorManager.getInstance().myActor.teamList.length; i++){	
