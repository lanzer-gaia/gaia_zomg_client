package com.gaiaonline.battle.moduleManagers
{
	...
	// This manager works with both the ActorInfoModule and the TargetInfoModule.
	
	final public class TargetInfoModuleManager implements IModuleManager, IAsyncCreationHandler
	{
		...
		public function onCreation(instance:Object, modulePath:String):void
		{
			...
			// [kja] snap a parent window onto the targetInfo for now
		...
		private function open(e:GlobalEvent):void {
			if (this._instance == null) {
				...
				if (this._window) {
					...
					if (this._window && 
							!_winUtils.isWindowOpen(this._window.parent) && 
							this._mostRecentlySelectedActorRef && 
							this._mostRecentlySelectedActorRef.get()) {
