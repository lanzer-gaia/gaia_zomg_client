package com.gaiaonline.battle
{
	...
	public class GlobalTexts
	{
		...
		public static function getHudCLTooltip(capped:Boolean):String {
			var baseString:String = "Overall CL";
			if (capped) {
				baseString += " (Capped)";
			}
...
//		public static function getNewGhiCenterPrint():String{
//			return "You've earned a new Ghi ability!";
//		} 
		...
		public static function getFriendRequestAccepted(userName:String):String{
			var s:String = "<br><p>" + userName + " is now your friend</p>" + 
						   "<a href ='event:close'>OK</a>"	 
