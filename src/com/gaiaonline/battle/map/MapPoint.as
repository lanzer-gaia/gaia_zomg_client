/// MapPoint
///
/// Like Point, but with four sets of coord values. This class is helpful
/// because now you don't have convert coord types over and over. This 
/// is VITAL to maintain cood fidelity.
///
...
public class MapPoint
{
	...
	private static var cMapRes:Number = 8; // the resolution of the map data
	private static var pfRes:Number = 3;
	
	private var scale:Number = 100; // int, percentage representing the "zoom factor" of this room. Typical rooms are at 75, or 75%.
	...
	function MapPoint(x:Number, y:Number, mapNodeType:Number, scl:Number)
	{
		this.scale = scl;
