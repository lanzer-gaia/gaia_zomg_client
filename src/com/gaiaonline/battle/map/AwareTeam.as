package com.gaiaonline.battle.map
{
	...
	public class AwareTeam extends AwareObject
	{
		...
		public function initialize(args:Array):void {
			...
			// [bgh] we want to see through the whole room, not just half way through
