package com.gaiaonline.battle.utils
{
	...
	public class PulsatingGlowFilter {
		...
		public function PulsatingGlowFilter(mc:MovieClip, color:Number, alpha:Number=1, blurX:Number=5, blurY:Number=5,
											strength:Number=5,quality:Number=3,inner:Boolean=false, knockout:Boolean=false,speed:Number=1) {
		...
		private function onEnterFrame(e:Event):void {
		   	_blurX+=_speed;
		    _blurY+=_speed;
		    if(_blurY>25){_speed*=-1}
		    if(_blurY<5){_speed*=-1}
			var filter:GlowFilter = new GlowFilter(_color, 
		                                        _alpha, 
		                                        _blurX, 
		                                        _blurY, 
		                                        _strength, 
