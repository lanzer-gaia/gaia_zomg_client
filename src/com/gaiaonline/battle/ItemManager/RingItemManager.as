package com.gaiaonline.battle.ItemManager
{
	...
	public class RingItemManager extends ItemManager
	{
		...
		public function RingItemManager(se:SingletonEnforcer) {
			super();
			if (!se) {
		...
		static public function getInstance():RingItemManager {
			if (!_instance) {
				_instance = new RingItemManager(new SingletonEnforcer());
			}
