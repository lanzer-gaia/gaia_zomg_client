package com.gaiaonline.battle.newrings
{
	...
	public class RingAnimPoolObj implements IObjectPoolFactory, IObjectPoolCleanUp, IObjectPoolInitializer, IObjectPoolDeconstructor
	{
		...
		private var _ringGarbageStopperDist:DisplayObjectStopper = new DisplayObjectStopper(DisplayObjectStopperModes.SHOW_NO_ANIM, true);
		...
		public function init():void{
			var classBack:Class
			var classDist:Class;
			var classFront:Class;
			var classGround:Class;	
