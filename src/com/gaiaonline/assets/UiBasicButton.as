package com.gaiaonline.assets
{
	...
	public class UiBasicButton extends MovieClip
	{
		...
		public function UiBasicButton(captionTxt:String="",activeButton:Boolean=true,centerAlign:Boolean=false,wdth:int=-1, textAlign:String = TextFieldAutoSize.LEFT ){
